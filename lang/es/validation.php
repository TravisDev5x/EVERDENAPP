...
return [
    ...
    'custom' => [
        ...
        'plan_id'          => ['required' => 'Debes seleccionar un plan.', 'exists' => 'El plan seleccionado no es válido.'],
        'payment_method'   => ['required' => 'Los datos de la tarjeta son obligatorios.'],
        'privacy_notice_accepted' => ['accepted' => 'Debes aceptar el aviso de privacidad y los términos del servicio.'],
    ],
    ...
    'attributes' => [
        ...
        'main_branch_name'        => 'nombre de sucursal principal',
        'plan_id'                 => 'plan',
        'payment_method'          => 'método de pago',
        'privacy_notice_accepted' => 'aviso de privacidad',
