...
function Sidebar({
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Sidebar gap on desktop: reserva el ancho en el flujo */}
      <div
...
function SidebarGroup({
  ...
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col gap-1 px-3 py-2 group-data-[collapsible=icon]:px-0", className)}
      {...props}
    />
  );
}
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        "flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-semibold text-sidebar-foreground/50 outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 focus-visible:ring-sidebar-ring [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground hover:bg-transparent absolute top-3.5 right-3 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-opacity [@media(hover:hover)]:hover:opacity-70 focus-visible:ring-2 focus-visible:ring-sidebar-ring [&>svg]:size-4 [&>svg]:shrink-0",
  ...
  "peer/menu-button flex w-full appearance-none items-center gap-3 overflow-hidden rounded-lg bg-sidebar px-2 py-2 text-left text-sm font-normal text-sidebar-foreground outline-hidden transition-[width,height,padding] hover:bg-sidebar hover:text-sidebar-foreground active:bg-sidebar focus-visible:bg-sidebar focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:ring-offset-0 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:font-semibold data-[active=true]:text-sidebar-foreground data-[active=true]:[&>svg]:text-sidebar-foreground data-[state=open]:hover:bg-sidebar group-data-[collapsible=icon]:!size-9 group-data-[collapsible=icon]:!p-2 group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:mx-auto group-data-[collapsible=icon]:[&>span:last-child]:sr-only [&>span:last-child]:truncate [&>svg]:size-[18px] [&>svg]:shrink-0 [&>svg]:text-sidebar-foreground [&>svg]:stroke-[1.5]",
  {
    variants: {
      variant: {
        default: "",
        outline:
          "bg-sidebar shadow-[0_0_0_1px_var(--sidebar-border)] hover:bg-sidebar hover:text-sidebar-foreground hover:shadow-[0_0_0_1px_var(--sidebar-border)] focus-visible:shadow-[0_0_0_1px_var(--sidebar-border)]",
      },
      size: {
        default: "min-h-9 text-sm",
        sm: "min-h-8 py-1.5 text-xs",
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground hover:bg-transparent peer-hover/menu-button:text-sidebar-foreground absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-opacity [@media(hover:hover)]:hover:opacity-70 focus-visible:ring-2 focus-visible:ring-sidebar-ring [&>svg]:size-4 [&>svg]:shrink-0",
        "after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "text-sidebar-foreground hover:bg-transparent active:bg-transparent [&>svg]:text-sidebar-foreground flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md bg-transparent px-2 outline-hidden transition-opacity [@media(hover:hover)]:hover:opacity-90 focus-visible:ring-2 focus-visible:ring-sidebar-ring disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
        "data-[active=true]:bg-transparent data-[active=true]:font-medium data-[active=true]:text-sidebar-foreground",
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        className,
