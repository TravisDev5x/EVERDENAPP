...
export default function Suspended({ tenantDisplayName, suspensionReason }) {
    return (
        <GuestLayout>
            ...
            <div className="space-y-4 text-center">
                ...
                <p className="text-sm text-gray-600">
                    El acceso para <strong>{tenantDisplayName}</strong> está desactivado por la plataforma (por ejemplo,
                    falta de pago o incumplimiento). Tu equipo no puede operar la aplicación hasta que se reactive la
                    cuenta.
                </p>
                {suspensionReason && (
