...
Route::middleware(['auth', 'verified', 'tenant.context'])->group(function (): void {
    ...
    Route::get('/inventory/transfers', [InventoryTransferPageController::class, 'index'])
        ->name('inventory.transfers.page');
    Route::get('/inventory/transfers/list', [InventoryTransferController::class, 'index'])
